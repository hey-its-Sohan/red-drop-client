      ...
      <section className="bg-linear-to-b from-primary from-50% to-secondary py-20 px-5 lg:px-0 text-white ">
        <div className=" mx-auto px-6 text-center max-w-3xl">
          ...
          <p className="text-xl opacity-90">
            Find compatible blood donors in your area quickly and easily
          </p>
        </div>
      </section>


      <section className='max-w-4xl mx-auto px-5 lg:px-0 py-16'>
        <div className='bg-white p-5 mb-10 rounded-xl shadow-lg shadow-primary/10'>
        ...
        {!loading && donors.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {donors.map((donor) => (
              ...
              <div
                key={donor._id}
                className="card bg-white shadow-md border-l-4 border-primary rounded-xl px-4 py-2 hover:shadow-lg transition-all"
              >
        ...
        {!loading && donors.length === 0 && (
          <>
            <p className="text-center text-3xl lg:text-4xl mt-20 text-gray-400">No donors found. Try a different search.</p>
